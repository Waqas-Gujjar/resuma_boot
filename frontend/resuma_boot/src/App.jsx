...
import "./index.css"; // Import your CSS for PDF styling
      ...
      >
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full border border-indigo-300 rounded-lg px-4 py-3"
          />
        </div>
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="w-full border border-indigo-300 rounded-lg px-4 py-3 resize-none h-32"
        ...
        <div className="w-full max-w-7xl mt-14 space-y-12">
          {feedbackList.map((item, index) => (
            ...
            >
              ...
              {/* Optimized Resume PDF container */}
              <section className="mb-8">
                <h3 className="text-lg font-semibold mb-3 text-green-600">
                  ✅ ATS-Optimized Resume
                </h3>
                <div id={`optimized-${index}`} className="pdf-wrapper">
                  <div
              ...
              {/* Cover Letter PDF container */}
              <section className="mb-6">
                <h3 className="text-lg  cursor-pointer font-semibold mb-3 text-purple-600">
                  📩 Suggested Cover Letter
                </h3>
                <div id={`cover-${index}`} className="pdf-wrapper">
                  <div
              ...
              <div className="flex flex-wrap justify-end gap-5 mt-4">
                <button
                  ...
                  className="text-sm font-medium cursor-pointer text-indigo-600 hover:text-indigo-800 underline"
                >
                  📋 Copy Resume
                </button>
                <button
                ...
                <button
                  ...
                  className="text-sm font-medium cursor-pointer text-green-600 hover:text-green-800 underline"
                >
                  ⬇️ Download Resume
                </button>
                <button
                ...
                <button
                  ...
                  className="text-sm font-medium cursor-pointer text-red-600 hover:text-red-800 underline"
                >
                  ❌ Remove
                </button>
              </div>
